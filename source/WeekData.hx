...
typedef WeekFile =
{
	...
	@:optional var songColors:Array<String>;
	@:optional var loadingScreens:Array<String>;
...
class WeekData {
	...
	public var songColors:Array<String>;
	public var loadingScreens:Array<String>;
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		songColors = weekFile.songColors != null ? weekFile.songColors : [];
		loadingScreens = weekFile.loadingScreens != null ? weekFile.loadingScreens : [];
	...
	public static function getWeekFiles(isStoryMode:Null<Bool> = false)
	{
		var weeksList = [];
