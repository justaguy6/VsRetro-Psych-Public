...
enum abstract Action(String) to String from String
{
	...
	var PAUSE = "pause";
	var RESET = "reset";
	var CHANGE_GF = "change_gf";
	var CHANGE_BF = "change_bf";
	var CHANGE_FOE = "change_gf";
}
#else
@:enum
...
class Controls extends FlxActionSet
{
	...
	var _change_gf  = new FlxActionDigital(Action.CHANGE_GF);
	var _change_bf = new FlxActionDigital(Action.CHANGE_BF);
	var _change_foe = new FlxActionDigital(Action.CHANGE_FOE);
	...
	public var CHANGE_FOE(get, never):Bool;

	inline function get_CHANGE_FOE()
		return _change_foe.check();

	public var CHANGE_BF(get, never):Bool;

	inline function get_CHANGE_BF()
		return _change_bf.check();

	public var CHANGE_GF(get, never):Bool;

	inline function get_CHANGE_GF()
		return _change_gf.check();
	...
	function getActionFromControl(control:Control):FlxActionDigital
	{
		return switch (control)
		{
			...
			case PAUSE: _pause;
			case RESET: _reset;
			case CHANGE_GF: _change_gf;
			case CHANGE_BF: _change_bf;
			case CHANGE_FOE: _change_foe;
		}
	}
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case CHANGE_GF:
				func(_change_gf, JUST_PRESSED);
			case CHANGE_BF:
				func(_change_bf, JUST_PRESSED);
			case CHANGE_FOE:
				func(_change_foe, JUST_PRESSED);
		}
	}
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.CHANGE_GF, keysMap.get('change_gf'));
				inline bindKeys(Control.CHANGE_BF, keysMap.get('change_bf'));
				inline bindKeys(Control.CHANGE_FOE, keysMap.get('change_foe'));
			case Duo(true):
	...
	public function addDefaultGamepad(id):Void
	{
		...
		addGamepadLiteral(id, [
			...
			Control.CHANGE_BF => [8],
			Control.CHANGE_GF => [9],
			Control.CHANGE_FOE => [EXTRA_0] //I ran out of universal gamepad buttons
		]);
		#else
		addGamepadLiteral(id, [
